...
class Carousel extends React.Component {
  ...
  componentWillMount() {
    let newShopifyClient = ShopifyBuy.buildClient({
    ...
    newShopifyClient.createCart().then((newCart) => {
...
document.addEventListener('DOMContentLoaded', () => {
  ReactDOM.render(<Carousel />, document.getElementById('ca-react-component'));
});
