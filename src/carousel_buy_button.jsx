      ...
      <div id="ca-container" class="ca-container">
        <div class="ca-wrapper">
          <div class="ca-item ca-item-13">
            <div class="ca-item-main in-season">
              <div class="ca-icon"></div>
              <h4>
                <span>Peachy. Delicious.</span>
              </h4>

              <a href="#" class="ca-more">Read the story</a>
            </div>
          ...
          <div class="ca-item ca-item-10 out-of-season">
            <div class="ca-item-main">
              <span class="out-of-season coming-soon">4th of July Only</span>
              <div class="ca-icon flavor-icon slices"></div>
              <h3>Apple Pie</h3>
              <h4>
          ...
          <div class="ca-item ca-item-11 whole-food-exclusive">
            <div class="ca-item-main">
              <span class="out-of-season coming-soon">Whole Foods Exclusive</span>
              <div class="ca-icon flavor-icon"></div>
          ...
          <div class="ca-item ca-item-8 out-of-season">
            <div class="ca-item-main">
              <div class="ca-icon flavor-icon"></div>
              <span class="out-of-season">Out Of Season</span>
          ...
          <div class="ca-item ca-item-7 out-of-season">
            <div class="ca-item-main">
              <div class="ca-icon flavor-icon"></div>
              <span class="out-of-season">Out Of Season</span>
              <h3>Winter Sun</h3>
          ...
          <div class="ca-item ca-item-12 out-of-season">
            <div class="ca-item-main in-season">
              <div class="ca-icon flavor-icon breakfast"></div>
              <span class="out-of-season">Out Of Season</span>
          ...
          <div class="ca-item ca-item-9 out-of-season">
            <div class="ca-item-main">
              <span class="out-of-season">Out Of Season</span>
              <div class="ca-icon flavor-icon"></div>
              <h3>Berry Season</h3>
          ...
          <div class="ca-item ca-item-6 out-of-season">
            <div class="ca-item-main">
              <span class="out-of-season">Out Of Season</span>
              <div class="ca-icon flavor-icon"></div>
              <h3>Candy Cane</h3>
